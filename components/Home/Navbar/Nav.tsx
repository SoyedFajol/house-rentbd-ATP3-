    ...
    >
      <div className="flex items-center h-full justify-between w-[95%] sm:w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            href="/auth/signin"
            className="flex items-center cursor-pointer text-white hover:text-red-700 transition-all duration-200"
          >
            <FaUserCircle className="w-5 h-5" />
            <p className="font-bold text-xs sm:text-base">Register / Login</p>
          </Link>
          {/* {Burger menu} */}
          <HiBars3BottomRight
            onClick={openNav}
